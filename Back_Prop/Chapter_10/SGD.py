...
for epoch in range(10001):
    ...
    if epoch%100 == 0:
        print(f'epoch: {epoch}, ' +
              f'acc: {acc:.3f}, ' +
              f'loss: {loss:.3f}, '
              f'lrate: {sgd_optimizer.current_learning_rate}')
    ...
    sgd_optimizer.pre_update()
    sgd_optimizer.update_parameters(dense1)
    sgd_optimizer.update_parameters(dense2)
    sgd_optimizer.post_update()
